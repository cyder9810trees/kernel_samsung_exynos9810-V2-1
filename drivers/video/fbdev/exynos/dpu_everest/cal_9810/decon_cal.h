 ...
 *
 * Header file for Exynos9810 DECON CAL
 *
...
/* IDMA Type Mappings */
#define IDMA_G0      IDMA_G0
#define IDMA_G1      IDMA_G1
#define IDMA_VG0     IDMA_VG0
#define IDMA_VG1     IDMA_VG1
#define IDMA_VGFS    IDMA_VGF0
